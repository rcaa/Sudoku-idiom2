...
//	}
	...
	public boolean solutionHint() {
		...
		try {
			setBusy(true);
			List solutions = hook_generateSolutions();
	...
	private List hook_generateSolutions() throws CloneNotSupportedException {
		//return solve((Board) board.clone());
